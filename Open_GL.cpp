...
#include <iostream>
    ...
    // lighting
<<<<<<< HEAD
    glm::vec3 lightPos(1.9f, 5.0f, 1.0f);
=======
    glm::vec3 lightPos(1.9f, 1.0f, 1.0f);
...
<<<<<<< HEAD
        ...
        /*Shader ourShader("shaders/55.vs", "shaders/34.frag");*/
        ...
        // load textures
        // -------------
        unsigned int cubeTexture = loadTexture("iron.jpg");
        unsigned int floorTexture = loadTexture("iron.jpg");
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            glm::vec3 lightColor = glm::vec3(0.2f, 0.6f, 0.1f);
            ...
            matShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f); // specular lighting doesn't have full effect on this object's material
            ...
            // material properties
            lightingShader.setFloat("material.shininess", 120.0f);
...
=======
        ...
        GLfloat vertices1[] = {
            // Positions          // Texture Coords
             3.5f,  3.5f, 3.0f,   1.0f, 1.0f, // Top Right
             3.5f, -3.5f, 3.0f,   1.0f, 0.0f, // Bottom Right
            -3.5f, -3.5f, 3.0f,   0.0f, 0.0f, // Bottom Left
            -3.5f,  3.5f, 3.0f,   0.0f, 1.0f  // Top Left 
        };
